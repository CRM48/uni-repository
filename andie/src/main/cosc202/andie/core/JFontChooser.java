 ...
 * Original code provided by https://github.com/NigoroJr/typebest
 * Code redistributed under the MIT license
 ************************************************************/
...
public class JFontChooser extends JComponent {
   ...
   *
   * @return the style of the selected font. <code>Font.PLAIN</code>, <code>Font.BOLD</code>, <code>
   *     Font.ITALIC</code>, <code>Font.BOLD|Font.ITALIC</code>
  ...
  protected class DialogOKAction extends AbstractAction {
    ...
    protected DialogOKAction(JDialog dialog) {
      ...
      putValue(Action.NAME, evalString(ACTION_NAME));
    }
  ...
  protected JDialog createDialog(Component parent) {
    ...
    JDialog dialog = new JDialog(frame, evalString("SelectFont"), true);
  ...
  protected JPanel getFontFamilyPanel() {
    if (fontNamePanel == null) {
      ...
      JLabel label = new JLabel(evalString("FontName"));
  ...
  protected JPanel getFontStylePanel() {
    if (fontStylePanel == null) {
      ...
      JLabel label = new JLabel(evalString("FontStyle"));
      label.setHorizontalAlignment(JLabel.LEFT);
      label.setHorizontalTextPosition(JLabel.LEFT);
  ...
  protected JPanel getFontSizePanel() {
    if (fontSizePanel == null) {
      ...
      JLabel label = new JLabel(evalString("FontSize"));
      label.setHorizontalAlignment(JLabel.LEFT);
      label.setHorizontalTextPosition(JLabel.LEFT);
    ...
    if (samplePanel == null) {
      Border titledBorder =
          BorderFactory.createTitledBorder(
              BorderFactory.createEtchedBorder(), evalString("Sample"));
  ...
  protected JTextField getSampleTextField() {
    if (sampleText == null) {
      ...
      sampleText = new JTextField(evalString("SampleString"));
  ...
  protected String[] getFontStyleNames() {
    if (fontStyleNames == null) {
      ...
      fontStyleNames[i++] = evalString("Plain");
      fontStyleNames[i++] = evalString("Bold");
      fontStyleNames[i++] = evalString("Italic");
      fontStyleNames[i++] = evalString("BoldItalic");
    }
