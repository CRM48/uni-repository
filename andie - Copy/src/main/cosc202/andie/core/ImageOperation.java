 ...
 *
 * <p>Classes implementing ImageOperation represent operations that can be applied to images. Each
 * operation takes an image as input and provides an updated image as output.
 *
 * <p>A distinction should be made between an ImageOperation and an {@link ImageAction}. An
...
public interface ImageOperation {
   ...
   *
   * <p>ImageOperations may be either done in-place (that is, modifying the input image), or create
   * a new BufferedImage to store the result. This decision is left to the implementer of specific
   * operations.
   *
