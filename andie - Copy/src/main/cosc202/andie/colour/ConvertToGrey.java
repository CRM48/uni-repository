 ...
 *
 * <p>The images produced by this operation are still technically colour images, in that they have
 * red, green, and blue values, but each pixel has equal values for red, green, and blue giving a
 * shade of grey.
 *
...
public class ConvertToGrey implements ImageOperation, java.io.Serializable {
   ...
   *
   * <p>The conversion from red, green, and blue values to greyscale uses a weighted average that
   * reflects the human visual system's sensitivity to different wavelengths -- we are most
   * sensitive to green light and least to blue.
   *
