 ...
 * Modified to reduce rounding errors
 */
...
public class Count5 {
    ...
    public static long calculation(long n, long k) {
        ...
        for (long i = n; i > min; i--) {
            ...
            nk = (i - min) / nk;
            // System.out.println("NK1: " + nk);

            nk = i * nk;
            // System.out.println("NK2: " + nk);

            excess = (double) i * excess / (double) (i - min);
            excess += (double) temp / (double) (i - min) - nk;
            // System.out.println("Excess1: " + excess);

            nk += (long) excess;
            excess -= (long) excess;
            // System.out.println("Excess2: " + excess);
        }
